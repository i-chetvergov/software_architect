...
| **FR-10** | Администрирование и конфигурация | Админ-интерфейс и/или Admin API: политики, номера, маршрутизация, роли и права, интеграции | BG-08 | C4 Containers (Provisioning/Admin) |
...
**Связь с архитектурой:** Provisioning/Admin Service + API Gateway.  
**Связь с диаграммами:** C4 Containers.
