### 10. Диаграммы архитектуры UC-платформы
...
#### 10.1. C4 Context Diagram (`c4_context.puml`)
...
#### 10.2. C4 Container Diagram (`c4_containers.puml`)
...
#### 10.3. Deployment Diagram (`deployment.puml`)
...
#### 10.4. Sequence Diagrams (`sequences.puml`)
...
#### 10.5. Связь с разделом «Архитектурное решение» и ADR
